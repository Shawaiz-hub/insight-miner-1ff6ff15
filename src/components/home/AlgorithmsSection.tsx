...
const algorithms = [
  ...
  },
  {
    name: "dEclat",
    icon: Binary,
    description: "ECLAT with diffset optimization for memory-efficient mining of deep patterns.",
    features: ["Diffset format", "Memory efficient", "Deep patterns"],
    color: "from-teal-500/20 to-teal-500/5",
    href: "/dashboard?algo=declat",
  },
  {
    name: "CHARM",
    icon: Lock,
  ...
  },
  {
    ...
    features: ["Maximal patterns", "Look-ahead pruning", "Minimal output"],
    color: "from-purple-500/20 to-purple-500/5",
    href: "/dashboard?algo=fpmax",
  },
  {
    name: "Fuzzy Apriori",
    icon: Cpu,
    description: "Handles quantitative data with fuzzy membership functions for uncertain patterns.",
    features: ["Fuzzy sets", "Quantitative data", "Membership functions"],
    color: "from-pink-500/20 to-pink-500/5",
    href: "/dashboard?algo=fuzzy-apriori",
  },
];
